function options = SetSpgOptions(varargin)
% SetSpgOptions : Set options for spg
%
% options = SetSpgOptions('param1',val1,'param2',val2,...) creates an options
...
%   
% SetSpgOptions with no input arguments and no output arguments displays all
%   parameter names and their possible values.
%
%   SetSpgOptions.m
%   $Revision: 0.1.2 $  $Date: 2012/06/06 $

  % Print out possible values of options.
  if nargin == 0 && nargout == 0
    fprintf(' Default parameters for BBopt.m:\n');
    fprintf('         CheckOpt : [          logical |         1 ] \n');
    fprintf('          Display : [ positive integer |         1 ] \n');
    fprintf(' LineSearchMethod : [ string           |     Curvy ] \n');
    fprintf('      MaxFunEvals : [ positive integer |     15000 ] \n');
    fprintf('          MaxIter : [ positive integer |       500 ] \n');
    fprintf('       PrintEvery : [ positive integer |       100 ] \n');
